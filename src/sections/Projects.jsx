import { Ambulance, ArrowUpRight, Github } from "lucide-react";
    ...
    return(
      ...
      <div className="absolute bottom-1/4 left-0 w-64 h-64 bg-highlight/5 rounded-full blur-3xl" />
        ...
        <div className="text-center mx-auto max-w-3xl mb-16">
            ...
            <p className="text-muted-foreground animate-fade-in animation-delay-200">A selection of my recent work, from complex web applictation to innovative tools that solve real-world problems</p>
        </div>
